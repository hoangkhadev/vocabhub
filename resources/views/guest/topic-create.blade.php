...
<form action="">
    <div class="flex flex-col gap-2 w-1/2 mb-10">
        ...
        <input type="text" name="name" id="name" placeholder="Enter Topic Title"
    ...
    <div class="mb-3 flex flex-col gap-4">
        <div class="bg-secondary rounded-xl">
            <div class="flex justify-between items-center border-b-2 border-b-gray-800 py-4 px-4">
                ...
                <div class="py-1 px-2 -mx-2 hover:bg-slate-700 hover:text-red-400 rounded-lg cursor-pointer">
            ...
            <div class="px-4 flex items-center gap-x-5">
                <div class="w-1/2 py-6">
                    ...
                    <div class="flex justify-between items-center">
                        <p class="text-xs font-medium">TERM (12/255)</p>
        ...
        <div class="bg-secondary rounded-xl">
            ...
            <div class="px-4 flex items-center gap-x-5">
                ...
                <div class="w-1/2 py-6">
                    <input type="text" placeholder="Enter Vietnamese" name="vietnames[]"
                        class="bg-transparent border-b-2 focus:border-b-amber-400 transition-all duration-300 outline-none text-white w-full mb-1 h-10">
                    <div class="flex justify-between items-center">
                        <p class="text-xs font-medium">TERM (12/255)</p>
                        <p class="text-xs font-medium text-cyan-400">VIETNAMESE</p>
        ...
        <div class="bg-secondary rounded-xl cursor-pointer group">
            <div class="px-4 py-10 flex justify-between">
                <p class="text-lg text-gray-900 font-medium">3</p>
                <div
                    class="text-base font-medium flex items-center gap-x-1 border-b-4 border-b-cyan-400 group-hover:border-b-amber-400 duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                        stroke="currentColor" class="w-5 h-5">
